    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-2 overflow-hidden rounded-xl p-2">
            ...
            <div class="flex flex-col gap-2">
                    ...
                    <div class="rounded-lg border border-border bg-card p-4">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="mt-1 text-2xl font-semibold text-foreground">{{ stats.totalCampaigns }}</p>
                            </div>
                    ...
                    <div class="rounded-lg border border-border bg-card p-4">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="mt-1 text-2xl font-semibold text-foreground">{{ stats.activeCampaigns }}</p>
                            </div>
                    ...
                    <div class="rounded-lg border border-border bg-card p-4">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="mt-1 text-2xl font-semibold text-foreground">{{ formatNumber(stats.totalEmailsSent) }}</p>
                            </div>
                            <div class="rounded-full bg-purple-100 p-3 dark:bg-purple-900/20">
                                <Send class="size-5 text-purple-600 dark:text-purple-400" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-lg border border-border bg-card p-4">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="mt-1 text-2xl font-semibold text-foreground">{{ formatCurrency(stats.revenue) }}</p>
                            </div>
                    ...
                    <div class="rounded-lg border border-border bg-card p-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xl font-semibold text-foreground">{{ stats.openRate }}%</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-lg border border-border bg-card p-4">
                        <div class="flex items-center gap-3">
                            <div class="rounded-full bg-green-100 p-2 dark:bg-green-900/20">
                                <MousePointerClick class="size-4 text-green-600 dark:text-green-400" />
                            </div>
                            <div>
                                <p class="text-sm font-medium text-muted-foreground">Click Rate</p>
                                <p class="mt-1 text-xl font-semibold text-foreground">{{ stats.clickRate }}%</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-lg border border-border bg-card p-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xl font-semibold text-foreground">{{ stats.conversionRate }}%</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-2">
                    <h2 class="text-base font-semibold text-foreground">Recent Campaigns</h2>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody>
                            ...
                            <td colspan="7" class="px-4 py-12 text-center">
                                <div class="flex flex-col items-center justify-center gap-2">
                                    ...
                                    <p class="text-xs text-muted-foreground">
                                        {{ searchQuery ? 'Try adjusting your search criteria' : 'No recent campaigns available' }}
                                    </p>
                                </div>
                            </td>
                        </tr>
                        ...
                        >
                            ...
                            <td class="px-4 py-3 align-middle">
                                <span class="text-sm text-muted-foreground">{{ campaign.type }}</span>
                            </td>
                            <td class="px-4 py-3 align-middle">
                                <span
                                    :class="[
                            ...
                            <td class="px-4 py-3 align-middle text-right">
                                <span class="text-foreground">{{ formatNumber(campaign.recipients) }}</span>
                            </td>
                            <td class="px-4 py-3 align-middle text-right">
                                <span class="text-foreground">{{ campaign.openRate }}%</span>
                            </td>
                            <td class="px-4 py-3 align-middle text-right">
                                <span class="text-foreground">{{ campaign.clickRate }}%</span>
                            </td>
                            <td class="px-4 py-3 align-middle">
                                <span class="text-sm text-muted-foreground">{{ campaign.createdAt }}</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
