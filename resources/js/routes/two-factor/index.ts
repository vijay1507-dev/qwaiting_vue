 ...
 * @route '/crm/two-factor-challenge'
 */
 ...
 * @route '/crm/user/two-factor-authentication'
 */
...
enable.definition = {
    methods: ["post"],
    url: '/crm/user/two-factor-authentication',
 ...
 * @route '/crm/user/confirmed-two-factor-authentication'
 */
...
confirm.definition = {
    methods: ["post"],
    url: '/crm/user/confirmed-two-factor-authentication',
} satisfies RouteDefinition<["post"]>
 ...
 * @route '/crm/user/two-factor-qr-code'
 */
...
qrCode.definition = {
    methods: ["get","head"],
    url: '/crm/user/two-factor-qr-code',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/crm/user/two-factor-secret-key'
 */
...
secretKey.definition = {
    methods: ["get","head"],
    url: '/crm/user/two-factor-secret-key',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/crm/user/two-factor-recovery-codes'
 */
...
recoveryCodes.definition = {
    methods: ["get","head"],
    url: '/crm/user/two-factor-recovery-codes',
} satisfies RouteDefinition<["get","head"]>
