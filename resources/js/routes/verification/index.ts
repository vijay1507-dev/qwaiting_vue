 ...
 * @route '/crm/email/verify/{id}/{hash}'
 */
 ...
 * @route '/crm/email/verification-notification'
 */
...
send.definition = {
    methods: ["post"],
    url: '/crm/email/verification-notification',
