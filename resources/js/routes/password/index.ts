 ...
 * @route '/crm/reset-password/{token}'
 */
 ...
 * @route '/crm/user/confirm-password'
 */
 ...
 * @route '/crm/user/confirmed-password-status'
 */
...
confirmation.definition = {
    methods: ["get","head"],
    url: '/crm/user/confirmed-password-status',
} satisfies RouteDefinition<["get","head"]>
