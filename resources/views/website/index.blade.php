...
@section('content')
    ...
    <!-- <div id="cookieConsent" class="fixed bottom-0 left-0 right-0 z-50 hidden bg-white border-t border-gray-200 shadow-[0_-4px_20px_rgba(0,0,0,0.08)] transform translate-y-full opacity-0">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div class="flex-1 text-sm text-gray-700">
                    <p class="leading-relaxed">
                        ...
                        <a href="/privacy-policy" class="text-gray-900 hover:text-gray-700 font-medium underline underline-offset-2 transition-colors duration-200">Cookies settings</a>
                    </p>
                </div>
                <div class="flex items-center gap-3 flex-shrink-0">
                    <button id="cookieDecline" class="px-5 py-2.5 text-sm font-semibold text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 whitespace-nowrap">
                        Do not allow cookies
                    </button>
                    <button id="cookieAccept" class="px-5 py-2.5 text-sm font-semibold text-white bg-gray-900 rounded-lg hover:bg-gray-800 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2 whitespace-nowrap">
                        Allow all cookies
                    </button>
                    <button id="cookieClose" class="p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 rounded-lg">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- <script>
        ...
        (function() {
            ...
            function hideBanner() {
                cookieConsent.style.transition = 'transform 0.3s ease-out, opacity 0.3s ease-out';
            ...
            cookieClose.addEventListener('click', function() {
                // Don't set cookie on close, just hide the banner
