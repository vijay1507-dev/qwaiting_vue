...
@section('content')
    <div class="font-sans antialiased text-gray-900 bg-white selection:bg-indigo-100 selection:text-indigo-700">
        ...
        <!-- Hero Section -->
        <section class="relative pt-32 pb-20 overflow-hidden bg-gradient-to-b from-slate-50/50 to-white lg:pt-40 lg:pb-32">
            <!-- Background Decorations -->
            <div
                class="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 bg-gradient-to-br from-indigo-100 to-blue-100 rounded-full blur-3xl opacity-50">
            </div>
            <div
                class="absolute bottom-0 left-0 -ml-20 -mb-20 w-80 h-80 bg-gradient-to-tr from-sky-100 to-slate-100 rounded-full blur-3xl opacity-50">
            </div>
                ...
                <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div class="space-y-8 animate-fade-in-up">
                        ...
                        <h1 class="text-4xl lg:text-5xl font-extrabold tracking-tight text-gray-900 leading-tight">
                            Transforming Waiting into Growth - <span
                                class="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-blue-600">A CEO's
                                Guide</span>
                            to Virtual Queue Management
                        </h1>

                        <div class="space-y-6 text-lg text-gray-600">
                            <p class="leading-relaxed">
                                Long queues drain time, frustrate customers, and hurt business performance across
                                industries. This ebook explores how Virtual Queue Management can completely redefine
                                customer experiences — making waiting seamless, efficient, and contactless.
                            </p>
                            <p
                                class="leading-relaxed border-l-4 border-indigo-500 pl-4 italic bg-indigo-50/50 py-2 pr-2 rounded-r-lg">
                                Learn how businesses in healthcare, retail, banking, and government are using Qwaiting to
                                reduce walkouts, boost satisfaction, and gain real-time visibility into operations. From
                                AI-driven insights to omnichannel engagement, this guide is your blueprint to transforming
                                queues into powerful moments of customer delight.
                            </p>
                        </div>
                    ...
                    <div class="relative lg:h-auto animate-fade-in-right">
                        <!-- Decorative Blob -->
                        <div
                            class="absolute -inset-4 bg-gradient-to-r from-indigo-500 to-blue-500 rounded-2xl opacity-20 blur-2xl">
                        </div>
                        ...
                        <div
                            ...
                            <img src="https://qwaiting.com/images/the-ceo-playbook-for-virtual-queue-management.jpg"
                                alt="A CEO's Guide to Virtual Queue Management" class="w-full h-auto object-cover">
                            ...
                            <div
                                ...
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-xs font-semibold text-indigo-600 uppercase tracking-wider">Executive
                                            Brief</p>
                                        <p class="text-sm font-medium text-gray-900">Queue Management Strategy</p>
                                    </div>
                                </div>
                            </div>
                        </div>
