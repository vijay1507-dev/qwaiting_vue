...
class UpdateSequenceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'emails.*.timing_unit' => ['required', 'in:immediate,minutes,hours,days,weeks,days_before_expiry,on_expired'],
            'emails.*.subject' => ['required', 'string', 'max:255'],
            'emails.*.type' => ['required', 'in:welcome,feature_highlight,social_proof,trial_reminder,sales_outreach,offer'],
