...
class StoreSequenceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'emails.*.type' => ['required', 'in:welcome,feature_highlight,social_proof,trial_reminder,sales_outreach,offer,registeration_complete,signup_nudge,upsell,renewal_reminder,feature_update,feedback_request,loyalty_reward'],
